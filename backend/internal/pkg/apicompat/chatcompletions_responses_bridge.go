...
// ChatOutput returns the final Responses output items accumulated by the stream
// bridge. It is used by stateful Responses->Chat fallback to persist the
// assistant turn for future previous_response_id requests.
...
// ReasoningText returns the accumulated upstream reasoning_content text.
